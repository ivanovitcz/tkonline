		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<div class="footer-logo">
						<a class="logo" href="#">
							<img src="frontend/img/logokonveksi.png" alt="">
						</a>
					</div>
					<!-- /footer logo -->

					<p>Alamat : Nglaroh RT 01 RW 06, Nangsri, Kebakkramat, Karanganyar, Jawa Tengah, Indonesia</p>
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<ul class="list-links">
						<li><a data-toggle="modal" data-target="#myModal">Tentang</a></li>
								    ...
								    <div class="modal-dialog">
								      ...
								      <div class="modal-content">
								        ...
								        <div class="modal-header">
								          ...
								          <h4 class="modal-title">Customer Servis</h4>
								        </div>
								        <!-- body modal -->
