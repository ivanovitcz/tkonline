            ...
            <form action="admin_update.php" method="post" enctype="multipart/form-data">
              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <div class="form-group">
                  <label>Nama</label>
                  <input type="text" class="form-control" name="nama" value="<?php echo $d['admingudang_nama'] ?>" required="required">
                  <input type="hidden" class="form-control" name="id" value="<?php echo $d['admingudang_id'] ?>" required="required">
                </div>

                <div class="form-group">
                  <label>Username</label>
                  <input type="text" class="form-control" name="username" value="<?php echo $d['admingudang_username'] ?>" required="required">
                </div>
